    ...
    >
      <div className="w-full max-w-4xl px-4 md:px-8 mx-auto">
        <SectionHeader
          id="experience"
          title="Experience"
          desc="My journey in IoT, research & startups."
    ...
    >
      ...
      >
        ...
        <CardContent className="space-y-6">
          {experience.image && (
            <div className="w-full max-w-lg mx-auto overflow-hidden rounded-xl border border-border bg-muted/50 aspect-video">
              <Image 
